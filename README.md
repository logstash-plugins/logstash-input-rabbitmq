...
[![Unit Tests](https://github.com/logstash-plugins/logstash-input-rabbitmq/actions/workflows/unit-tests.yml/badge.svg?branch=main)](https://github.com/logstash-plugins/logstash-input-rabbitmq/actions/workflows/unit-tests.yml)
